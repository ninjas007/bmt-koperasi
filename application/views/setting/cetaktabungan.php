                                            ...
                                            <div class="row-fluid">
                                                <form class="form-horizontal" id="form_setbuku" method="post">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" class="input-small" name="set4"> cm
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label">Kode</label>
                                                        <div class="controls">
                                                            <input type="text" class="input-small" name="set5"> cm
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label">Debet</label>
                                                        <div class="controls">
                                                            <input type="text" class="input-small" name="set6"> cm
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label">Kredit</label>
                                                        <div class="controls">
                                                            <input type="text" class="input-small" name="set7"> cm
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label">Saldo</label>
                                                        <div class="controls">
                                                            <input type="text" class="input-small" name="set8"> cm
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label">Petugas</label>
                                                        <div class="controls">
                                                            <input type="text" class="input-small" name="set9"> cm
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
